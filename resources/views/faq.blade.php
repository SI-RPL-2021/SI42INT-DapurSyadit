                ...
                <div id="accordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                                Dapur Syadit, a catering business that is located in Tegal, Central Java. This business was founded in 2019 with the main focus on the small scale, but now is already developing into a mid-scale business that can serve 500-700 boxes of ready-to-eat foods per week
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                Payment via GOPAY and OVO, you also can pay via COD (Cash On Delivery)
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                            <div class="card-body">
                                You have to sign in your account in this website, after that you can order by clicking "Order" Menu
                            </div>
                        </div>
                    </div>
                </div>
