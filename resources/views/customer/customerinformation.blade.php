    ...
    <header>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    <div class="full">
                        <a class="logo" href="index.html"><img src="{{URL::to('/')}}/informationassets/images/title.png" alt="DAPUR SYADIT" /></a>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="full">
                        <div class="right_header_info">
                            <ul>
                                <li class="dinone">Contact Us : <img style="margin-right: 15px;margin-left: 15px;" src="{{URL::to('/')}}/informationassets/images/phone_icon.png" alt="#"><a href="#">666</a></li>
                                <li class="dinone"><img style="margin-right: 15px;" src="{{URL::to('/')}}/informationassets/images/mail_icon.png" alt="#"><a href="#">dapursyadit@gmail.com</a></li>
                                <li class="dinone"><img style="margin-right: 15px;height: 21px;position: relative;top: -2px;" src="{{URL::to('/')}}/informationassets/images/location_icon.png" alt="#"><a href="#">Tegal, Jawa Tengah</a></li>
                                <li class="button_user"><a class="button active" href="#">Login</a><a class="button" href="#">Register</a></li>
                                <li><img style="margin-right: 15px;" src="{{URL::to('/')}}/informationassets/images/search_icon.png" alt="#"></li>
                                <li>
                                    <button type="button" id="sidebarCollapse">
                                        <img src="{{URL::to('/')}}/informationassets/images/menu_icon.png" alt="#">
                                    </button>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                  <div class=" col-md-12">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <form class="main_form">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <textarea class="textarea" placeholder="Description" type="text" name="Description"></textarea>
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="img-box">
                            <figure><img src="{{URL::to('/')}}/informationassets/images/catering.jpeg" alt="img" /></figure>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer_logo">
                          <a href="index.html"><img src="{{URL::to('/')}}/informationassets/images/logo1.jpg" alt="logo" /></a>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <ul class="lik">
